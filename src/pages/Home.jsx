    ...
    <section className="relative pt-32 pb-20 px-4 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl font-bold leading-tight mb-6 text-white">
            {userMode === 'b2b' ? (
              <>
                Potenzia il tuo{' '}
          ...
          <p className="text-lg sm:text-xl text-surface-300 mb-10 max-w-2xl mx-auto leading-relaxed">
            {userMode === 'b2b'
              ...
              : 'Impara le piu potenti tecniche di Programmazione Neuro-Linguistica, memoria e neuroscienze con un metodo interattivo ispirato a Duolingo. 10 minuti al giorno bastano.'
            }
          </p>
          ...
          <div className="mt-12 flex flex-wrap items-center justify-center gap-8 text-surface-400">
              ...
              <div className="bg-surface-800/50 rounded-xl p-5 border border-white/5">
                ...
                <div className="flex gap-1 mt-3">
                  {['L', 'M', 'M', 'G', 'V', 'S', 'D'].map((d, i) => (
                    <div key={i} className={`flex-1 h-6 rounded text-xs flex items-center justify-center font-medium ${i < 5 ? 'bg-accent-500/20 text-accent-400' : 'bg-surface-700 text-surface-500'}`}>
                      {d}
                    </div>
                  ))}
                </div>
...
function HowItWorksSection() {
  const steps = [
    { num: '01', title: 'Scegli il tuo percorso', desc: 'Fondamenti PNL, Tecniche di Memoria, Comunicazione o Neuroscienze. Ogni percorso e strutturato in moduli progressivi.', icon: Target },
    { num: '02', title: 'Impara con lezioni interattive', desc: 'Teoria chiara e concisa, quiz immediati, esercizi pratici. Come Duolingo, ma per la tua mente.', icon: Brain },
    { num: '03', title: 'Pratica ogni giorno', desc: 'Sfide giornaliere, streak motivazionali e tecniche da applicare subito nella vita reale.', icon: Zap },
    { num: '04', title: 'Misura i tuoi progressi', desc: 'Dashboard con statistiche, XP, achievement e certificati al completamento di ogni percorso.', icon: TrendingUp }
  ]
  ...
  return (
    <section className="py-24 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="font-display text-3xl sm:text-4xl font-bold text-white mb-4">Come funziona</h2>
          <p className="text-surface-300">Un metodo semplice e scientificamente fondato</p>
        </div>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="relative overflow-hidden rounded-3xl">
          ...
          <div className="relative z-10 p-10 sm:p-16 text-center">
            <h2 className="font-display text-3xl sm:text-4xl font-bold text-white mb-4">
              {userMode === 'b2b' ? 'Porta il tuo team al livello successivo' : 'Inizia oggi il tuo viaggio mentale'}
            </h2>
            <p className="text-primary-100/80 max-w-xl mx-auto mb-8">
              {userMode === 'b2b'
                ? 'Richiedi una demo gratuita e scopri come NeuroMaster puo trasformare la formazione aziendale.'
                : 'Unisciti a 25.000+ persone che stanno gia potenziando la propria mente. Il primo percorso e gratuito.'
              }
            </p>
            <Link
